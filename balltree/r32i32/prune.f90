...
CONTAINS
  ...
  RECURSIVE SUBROUTINE INNER(TREE_SIZE, LEVELS, INDICES, &
    ...
    INTEGER(KIND=INT32), INTENT(IN)                :: TREE_SIZE, LEVELS
    INTEGER(KIND=INT32), INTENT(OUT), DIMENSION(:) :: INDICES
    INTEGER(KIND=INT32), INTENT(IN), OPTIONAL      :: CURRENT_LEVEL, STARTING_INDEX
    INTEGER(KIND=INT32), INTENT(INOUT), OPTIONAL   :: NEXT_INDEX
    ! Local variables
    INTEGER(KIND=INT32) :: SI, CL, I, TMID
  ...
  RECURSIVE SUBROUTINE LEVEL(TREE_SIZE, LAYER, INDICES, &
    ...
    INTEGER(KIND=INT32), INTENT(IN)                :: TREE_SIZE, LAYER
    INTEGER(KIND=INT32), INTENT(OUT), DIMENSION(:) :: INDICES
    INTEGER(KIND=INT32), INTENT(INOUT)             :: FOUND
    INTEGER(KIND=INT32), INTENT(IN), OPTIONAL :: STARTING_INDEX
    ! Local variables
    INTEGER(KIND=INT32) :: SI, TMID
